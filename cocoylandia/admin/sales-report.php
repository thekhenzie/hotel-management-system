                                        ...
                                        <div id="all">
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="alltable">
                                                    ...
                                                    <?php 
                                                    include './auth.php';
                                                    $re = mysql_query("SELECT * FROM booking WHERE isCocoylandia = 1");
                                                ...
                                                <?php
                                                $row = mysql_fetch_array(mysql_query("SELECT SUM(amount_paid) FROM booking WHERE isCocoylandia = 1"));
                                        ...
                                        <div id="annual">
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="annualtable">
                                                    ...
                                                    <?php 
                                                    include './auth.php';
                                                    $re = mysql_query("SELECT * FROM booking WHERE booking_date BETWEEN (DATE_ADD(NOW(), INTERVAL -1 YEAR)) and (NOW()) AND isCocoylandia = 1");
                                                ...
                                                <?php
                                                $row = mysql_fetch_array(mysql_query("SELECT SUM(amount_paid) FROM booking WHERE booking_date BETWEEN (DATE_ADD(NOW(), INTERVAL -1 YEAR)) and (NOW()) AND isCocoylandia = 1"));
                                                echo '<h5>TOTAL: ₱ <b>'.number_format(array_sum($row)).'</b></h5>' 
                                                ?>
                                            </div>
                                        </div>
                                        <div id="monthly">
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="monthlytable">
                                                    ...
                                                    <?php 
                                                    include './auth.php';
                                                    $re = mysql_query("SELECT * FROM booking WHERE booking_date BETWEEN (DATE_ADD(NOW(), INTERVAL -1 MONTH)) and (NOW()) AND isCocoylandia = 1");
                                                ...
                                                <?php
                                                $row = mysql_fetch_array(mysql_query("SELECT SUM(amount_paid) FROM booking WHERE booking_date BETWEEN (DATE_ADD(NOW(), INTERVAL -1 MONTH)) and (NOW()) AND isCocoylandia = 1"));
                                                echo '<h5>TOTAL: ₱ <b>'.number_format(array_sum($row)).'</b></h5>' 
                                                ?>
                                            </div>
                                        </div>
                                        <div id="weekly">
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="weeklytable">
                                                    ...
                                                    <?php 
                                                    include './auth.php';
                                                    $re = mysql_query("SELECT * FROM booking WHERE booking_date BETWEEN (DATE_ADD(NOW(), INTERVAL -1 WEEK)) and (NOW()) AND isCocoylandia = 1");
                                                ...
                                                <?php
                                                $row = mysql_fetch_array(mysql_query("SELECT SUM(amount_paid) FROM booking WHERE booking_date BETWEEN (DATE_ADD(NOW(), INTERVAL -1 WEEK)) and (NOW()) AND isCocoylandia = 1"));
                                                echo '<h5>TOTAL: ₱ <b>'.number_format(array_sum($row)).'</b></h5>' 
                                                ?>
                                            </div>
                                        </div>
                                        <div id="daily">
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="dailytable">
                                                    ...
                                                    <?php 
                                                    include './auth.php';
                                                    $re = mysql_query("SELECT * FROM booking WHERE booking_date BETWEEN (DATE_ADD(NOW(), INTERVAL -1 DAY)) and (NOW()) AND isCocoylandia = 1");
                                                ...
                                                <?php
                                                $row = mysql_fetch_array(mysql_query("SELECT SUM(amount_paid) FROM booking WHERE booking_date BETWEEN (DATE_ADD(NOW(), INTERVAL -1 DAY)) and (NOW()) AND isCocoylandia = 1"));
                                                echo '<h5>TOTAL: ₱ <b>'.number_format(array_sum($row)).'</b></h5>' 
                                                ?>
                                            </div>
                                        </div>
                                            ...
                                            <form method="POST">
                                                ...
                                                <table class="table table-striped" id="weeklytable">
                                                    ...
                                                    if(isset($_POST)){
                                                        ...
                                                        $re = mysql_query("SELECT * FROM booking WHERE booking_date BETWEEN '$rangeFrom' and '$rangeTo' AND isCocoylandia = 1");
                                                ...
                                                if(isset($_POST)){
                                                    ...
                                                    $row = mysql_fetch_array(mysql_query("SELECT SUM(amount_paid) FROM booking WHERE booking_date BETWEEN '$rangeFrom' and '$rangeTo' AND isCocoylandia = 1"));
                                                    echo '<h5>TOTAL: ₱ <b>'.number_format(array_sum($row)).'</b></h5>';
                                                }
                                                ?>
                                            </div>
