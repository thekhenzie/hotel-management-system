...
<head>
	...
	<title>Cocoylandia Family Resort | Dashboard</title>
				...
				<br/><h3 class="text-center">Current Reservations</h3>
					<div class="table-responsive">
						<table class="table table-striped" id="current">
							...
							<?php 
							include './auth.php';
							$re = mysql_query("SELECT * FROM booking WHERE isActive = 1 AND isReserved=1 AND isCancelled=0 AND isCocoylandia = 1");
					...
					<div class="table-responsive">
						<table class="table table-striped" id="roomtable">
                                ...
                                <tbody>
                                    <?php
										include './auth.php';
										$re = mysql_query("SELECT * from room WHERE isCottage=0 AND isCocoylandia = 1");
										if (mysql_num_rows($re) > 0) {
											while ($row = mysql_fetch_array($re)) {
												echo '
                                                    <tr>
