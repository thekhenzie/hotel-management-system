...
$sql = "INSERT INTO room (total_room, occupancy, size, view, room_name, descriptions, rate, imgpath,isCocoylandia) VALUES ('" . $total . "', '" . $occupancy . "', '" . $size . "', '" . $view . "', '" . $room_name . "', '" . $desc . "', '" . $rate . "', '" . $imgpathForSQL . "',1)";
