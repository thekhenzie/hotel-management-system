...
$sql = "INSERT INTO room (total_room, occupancy, size, view, room_name, descriptions, rate, imgpath, isCottage, isCocoylandia) VALUES ('" . $total . "', '" . $occupancy . "', '" . $size . "', '" . $view . "', '" . $room_name . "', '" . $desc . "', '" . $rate . "', '" . $imgpathForSQL . "',1,1)";
