...
<head>
	...
	<title>Cocoylandia Family Resort | Reservation</title>
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="table-responsive">
                            <table class="table table-striped" id="current">
                                ...
                                <?php 
                                include './auth.php';
                                $re = mysql_query("SELECT * FROM booking WHERE isReserved=1 AND isCancelled = 0 AND isActive = 2 AND isCocoylandia=1");
